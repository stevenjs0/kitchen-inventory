-- SEEDERS PARA BASE DE DATOS DE INVENTARIO
-- Este script asume que las tablas ya existen y están vacías
-- Ejecutar después de setup_database.sql

-- =====================================================
-- 1. CATEGORIAS - Todas las categorías únicas
-- =====================================================
INSERT INTO categories (name, description, color) VALUES
  ...
  ('Electricos', 'Electrodomésticos y aparatos', '#6366F1'),
  ('Plasticos', 'Recipientes y utensilios de plástico', '#A855F7'),
  ...
  ('Reposteria', 'Ingredientes para repostería', '#FB7185'),
...
-- =====================================================
-- 2. UBICACIONES - Todas las ubicaciones únicas
-- =====================================================
-- Sección Alacena
...
-- =====================================================
-- 3. OBJETOS DE INVENTARIO - Todos los objetos
-- =====================================================
-- Sección Alacena
...
WHERE c.name = 'Lavabo'
  AND l.name = 'Alacena Arriba Izquierda, Primer Nivel'
...
SELECT
  ...
  1, 1, 'unidad'
FROM categories c, locations l
WHERE c.name = 'Electricos'
  AND l.name = 'Alacena Arriba Derecha, Primer Nivel'
ON CONFLICT DO NOTHING;
...
INSERT INTO inventory_items (name, category_id, location_id, stock_quantity, min_stock, unit)
SELECT
  'Model de Pastel Grande',
  c.id,
  l.id,
  1, 1, 'unidad'
FROM categories c, locations l
WHERE c.name = 'Metalico'
  AND l.name = 'Alacena Arriba Derecha, Primer Nivel'
ON CONFLICT DO NOTHING;
...
FROM categories c, locations l
WHERE c.name = 'Metalico'
  AND l.name = 'Alacena Arriba Derecha, Segundo Nivel'
ON CONFLICT DO NOTHING;

INSERT INTO inventory_items (name, category_id, location_id, stock_quantity, min_stock, unit)
SELECT
  'Respuesto de Exprimidor',
  c.id,
  l.id,
  1, 1, 'unidad'
FROM categories c, locations l
...
FROM categories c, locations l
WHERE c.name = 'Electricos'
  AND l.name = 'Alacena Arriba Izquierda, Segundo Nivel'
ON CONFLICT DO NOTHING;
...
FROM categories c, locations l
WHERE c.name = 'Vidrio'
  AND l.name = 'Alacena Arriba Derecha, Tercer Nivel'
ON CONFLICT DO NOTHING;
...
FROM categories c, locations l
WHERE c.name = 'Cereal'
  AND l.name = 'Alacena Abajo Derecha, Primer Nivel'
ON CONFLICT DO NOTHING;
...
WHERE c.name = 'Higiene'
  AND l.name = 'Alacena Arriba Izquierda, Tercer Nivel'
ON CONFLICT DO NOTHING;
...
SELECT
  ...
  1, 1, 'paquete'
FROM categories c, locations l
WHERE c.name = 'Reposteria'
  AND l.name = 'Alacena Abajo Derecha, Segundo Nivel'
ON CONFLICT DO NOTHING;
...
FROM categories c, locations l
WHERE c.name = 'Perro'
  AND l.name = 'Alacena Abajo Izquierda, Primer Nivel'
ON CONFLICT DO NOTHING;
...
FROM categories c, locations l
WHERE c.name = 'Granos'
  AND l.name = 'Alacena Abajo Izquierda, Segundo Nivel'
ON CONFLICT DO NOTHING;
...
FROM categories c, locations l
WHERE c.name = 'Comida'
  AND l.name = 'Alacena Abajo Derecha, Tercer Nivel'
ON CONFLICT DO NOTHING;
...
FROM categories c, locations l
WHERE c.name = 'Hierbas'
  AND l.name = 'Condimentero Izquierdo, Primer nivel'
ON CONFLICT DO NOTHING;
...
FROM categories c, locations l
WHERE c.name = 'Sazon'
  AND l.name = 'Condimentero Derecho, Primer nivel'
ON CONFLICT DO NOTHING;
...
FROM categories c, locations l
WHERE c.name = 'Granos'
  AND l.name = 'Condimentero Izquierdo, Segundo nivel'
ON CONFLICT DO NOTHING;
...
FROM categories c, locations l
WHERE c.name = 'Hierbas'
  AND l.name = 'Condimentero Derecho, Segundo nivel'
ON CONFLICT DO NOTHING;
...
SELECT
  ...
  1, 1, 'lata'
FROM categories c, locations l
WHERE c.name = 'Enlatados'
  AND l.name = 'Condimentero Izquierdo, Tercer nivel'
ON CONFLICT DO NOTHING;
...
FROM categories c, locations l
WHERE c.name = 'Sazon'
  AND l.name = 'Condimentero Derecho, Tercer nivel'
ON CONFLICT DO NOTHING;
...
FROM categories c, locations l
WHERE c.name = 'Granos'
  AND l.name = 'Condimentero Izquierdo, Cuarto nivel'
ON CONFLICT DO NOTHING;
